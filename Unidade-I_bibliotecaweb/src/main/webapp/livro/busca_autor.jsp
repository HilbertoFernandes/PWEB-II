...
<html>
<head>
<title>Biblioteca - Buscar livro - Autor</title>
...
<body
	...
	<div class="container"
		...
		<a href="${pageContext.request.contextPath}/usuario/home.jsp"
			type="button" class="close" aria-label="Close"><span class="glyphicon glyphicon-remove-circle" style="font-size:30px;color:red;"></span></a>
		<h3>Informe o autor desejado</h3>

		<form action="${pageContext.request.contextPath}/controller.do"
			method="POST" class="form-horizontal">
			<input type="hidden" name="op" value="ConsultaAutorComando">

			<input id="autor" value="" name="autor" class="form-control"
				type="text" placeholder="Nome do autor" />
